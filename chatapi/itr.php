...
define('CLIENT_ID', 'local.5e970dda6dd942.84852333'); // like 'app.67efrrt2990977.85678329' or 'local.5e970dda6dd942.84852333' - This code should take in a partner's site, needed only if you want to write a message from Bot at any time without initialization by the user
define('CLIENT_SECRET', 'yBhB2HfsGV6EvbknipmXAOhUShrle9IkhS4xaUEOsg2eptnV4G'); // like 'yBhB2HfsGV6EvbknipmXAOhUShrle9IkhS4xaUEOsg2eptnV4G' - TThis code should take in a partner's site, needed only if you want to write a message from Bot at any time without initialization by the user
#####################
